...
<link rel="stylesheet" href="<?php echo $shared_path ?>/shared/plugins/plugins.css?v=3">
<script>
...
<script src="<?php echo $shared_path ?>/shared/plugins/plugins.js?v=2"></script>
<script src="<?php echo $shared_path ?>/shared/plugins/popup.js?v=7" type="text/javascript"></script>
<script>    
    var mainNow = 0;    

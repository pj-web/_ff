<?php
global $companyInfo, $landings_default_domain, $default_main_site, $shared_path;
...
<?php if ($linksPosition == 'line'): ?>
    ...
    <p class="tlight-link">
        ...
        <?php if ($doclinks): ?>
            <a class="nav-link" href="" onclick="window.open('<?= $shared_path ?>/policykz.php'); return false;">Политика

...
<style>
    ...
    .visitors-today {background-image: url(<?php echo $shared_path ?>/shared/plugins/icons/users-color-64.png);height: 28px;padding-left: 45px;background-repeat: no-repeat;background-position: 5px;margin-left: 10px;display: inline-block;padding-top: 8px;margin-top: 0;}
    .visitors-now {background-image: url(<?php echo $shared_path ?>/shared/plugins/icons/eye-color-64.png);height: 28px;padding-left: 45px;background-repeat: no-repeat;background-position: 5px;margin-left: 10px;display: inline-block;padding-top: 8px;margin-top: 0;border-left: 2px dashed #cccccc;}
    .buy-today {background-image: url(<?php echo $shared_path ?>/shared/plugins/icons/buy-color-64.png);height: 28px;padding-left: 45px;background-repeat: no-repeat;background-position: 5px;margin-left: 10px;display: inline-block;padding-top: 8px;margin-top: 0;border-left: 2px dashed #cccccc;}

<?php
global $companyInfoEN, $landings_default_domain, $default_main_site, $shared_path;
...
<?php if($linksPosition == 'line'): ?>
    ...
    <p class="tlight-link">
      ...
      <?php if($doclinks): ?>
        <a class="nav-link"  href="" onclick="window.open('<?= $shared_path ?>/policy_en.php'); return false;">Privacy Policy</a>
        <a class="nav-link"  href="" onclick="window.open('<?= $shared_path ?>/terms_en.php'); return false;">Terms & Conditions</a>
      <?php endif ?>
    </p>

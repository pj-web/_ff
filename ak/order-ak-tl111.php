<?php 
  ...
  $offer_id = 6981; // для каждого оффера свой айди, надо уточнять его в админке или у суппортов "Примечание от Ильи: указан id оффера 'Видеорегистратор Neoline X-COP 9100S за 1990 руб (Без МО и МСК)' но лучше уточнить правильный ли id у саппорта"
  $stream_hid = 'VrxFlK92'; // не обязательное, если указано, заявка будет привязана к потоку "Примечание от Ильи: Указан уникальный код потока, дляоффера 'Видеорегистратор Neoline X-COP 9100S за 1990 руб (Без МО и МСК)' работоспособность не проверенна!"
  ...
  header('Location: https://antking-official.ru/success.php'); // Вместо site_url указать свой домен
